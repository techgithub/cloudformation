        ...
        resolve: {
            loadMyDirectives:function($ocLazyLoad){
                return $ocLazyLoad.load(
                {
                    name:'sbAdminApp',
                    files:[
                    'assets/scripts/directives/header/header.js',
                    'assets/scripts/directives/header/header-notification/header-notification.js',
                    'assets/scripts/directives/sidebar/sidebar.js',
                    'assets/scripts/directives/sidebar/sidebar-search/sidebar-search.js'
                    ]
                }),
                $ocLazyLoad.load(
                {
        ...
        resolve: {
          loadMyFiles:function($ocLazyLoad) {
            return $ocLazyLoad.load({
              ...
              'assets/scripts/directives/timeline/timeline.js',
              'assets/scripts/directives/notifications/notifications.js',
              'assets/scripts/directives/chat/chat.js',
              'assets/scripts/directives/dashboard/stats/stats.js'
              ]
            })
          }
        }
      ...
      .state('dashboard.chart',{
        ...
        resolve: {
          loadMyFile:function($ocLazyLoad) {
            ...
            $ocLazyLoad.load({
                name:'sbAdminApp',
                files:['assets/scripts/controllers/chartContoller.js']
            })
          }
        }
    })
